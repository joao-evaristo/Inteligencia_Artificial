...
#Código de Felipe Martins dos SantosFelipe Martins dos Santos, disponível em https://github.com/felipemartinsss/RepositorioIAsc/blob/master/Python/buscas/buscas_ia.py.
#Retirei a parte de busca em largura e algumas funções que o autor usava para debug
#Também retirei a possibilidade de movimento para as diagonais que o autor usava, pois no problema original não é permitido esse tipo de movimento, fora que tornava o jogo muito mais fácil.
#O problema que ele se refere, do 'Duende Perdido', está disponível em https://www.beecrowd.com.br/judge/pt/problems/view/2294?origem=1
#Comentários originais foram mantidos.
